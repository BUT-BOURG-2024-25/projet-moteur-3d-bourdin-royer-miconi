...
public class Satellite : Power
{
    ...
    void CreateNewSatellite()
    {
        ...
        satellite.GetComponent<SatelliteBehaviour>().SetParentSatellite(this);
...
public class SatelliteBehaviour : MonoBehaviour
{
    ...
    public void SetParentSatellite(Satellite parentSatellite)
    {
        this.parentSatellite = parentSatellite;
    }
